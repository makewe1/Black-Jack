...
export default function App() {
    ...
    function handleLogout() {
        ...
        navigate("/", { replace: true }); // back to start page
    }
        ...
        <div className="app">
            ...
            <div className="panel">
                ...
                <div className="bet-row">
                    <div>
                        Bet:{" "}
                        <strong>{isPlaying ? currentBet : effectiveBet}</strong>
                    </div>
                    <div className="chips">
                        {chips.map((c) => (
                            <button
                        ...
                        <button onClick={clearBet} disabled={isPlaying}>
                            Clear
                        </button>
                        <button
                            className="deal"
            ...
            <div className="actions">
                <button onClick={onHit} disabled={!isPlaying}>
                    Hit
                </button>
                <button onClick={onStay} disabled={!isPlaying}>
                    Stay
                </button>
