...
export default function LoginPage({
  ...
  const Form = (
    <div className="login-form-wrap">
      <h3 className="login-title" style={{ fontFamily: '"Alex Brush", cursive' }}>
        {title}
      </h3>
      ...
      <div className="segment">
        <button
          className={`segment-btn ${mode === "password" ? "is-active" : ""}`}
          onClick={() => setMode("password")}
        >
          Password
        </button>
        <button
          className={`segment-btn ${mode === "code" ? "is-active" : ""}`}
        ...
        {mode === "password" ? (
          ...
          <>
            <div className="row mt">
              ...
              <span className="hint">We’ll email a 6-digit code</span>
            </div>
