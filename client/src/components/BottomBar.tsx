      ...
      {showingBet ? (
        <div className="betbar">
          ...
          <div className="chip-row">
            ...
            <button onClick={onClearBet} type="button">Clear</button>
            <button
              className="deal"
              onClick={onDeal}
        ...
        <div className="actionbar">
          ...
          <div className="ai-helper">
            <div className="ai-tooltip-wrapper">
              ...
              <div id="ai-tooltip" className="ai-tooltip">AI Recommendation</div>
            </div>
          </div>

          <button className="double" disabled type="button">DOUBLE</button>
          <button
